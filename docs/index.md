...
| [reflect](https://github.com/boost-ext/reflect)         | v1.0.9     | `#!cmake WrapperCPMAddPackage("gh:boost-ext/refelect@0.1.0")`                                       <br>CMakeTarget: `reflect::reflect`                        <br> requires [WrapperCPMAddPackage](https://github.com/SGSSGene/EnableCPM) |
