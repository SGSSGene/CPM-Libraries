...
| [7-zip](https://github.com/rikyoz/7-zip)                               | v24.07      | `#!cmake WrappedCPMAddPackage("gh:rikyoz/7-Zip@24.07")`                                             <br>CMakeTarget: `7-zip::7-zip`                            <br> requires [WrapperCPMAddPackage](https://github.com/SGSSGene/WrapperCPMAddPackage) |
| [sdsl-lite](https://github.com/xxsds/sdsl-lite)                        | v3.0.3      | `#!cmake WrappedCPMAddPackage("gh:xxsds/sdsl-lite@3.0.3")`                                          <br>CMakeTarget: `sdsl-lite::sdsl-lite`                    <br> requires [WrapperCPMAddPackage](https://github.com/SGSSGene/WrapperCPMAddPackage) |
